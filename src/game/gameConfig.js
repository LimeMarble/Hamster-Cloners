...
export const HAMSTER_COST_GROWTH_INCREASE_PER_HAMSTER = 0.0005
...
export const FLOOR_REPLICATOR_ACCELERATED_COST_SCALING_START = 500
export const FLOOR_REPLICATOR_ACCELERATED_COST_GROWTH_STEP = 5
